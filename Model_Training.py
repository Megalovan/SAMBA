...
from ComplexLayers_Torch import Beam_Classifier, Beam_Classifier_CNN, Beam_Classifier_CNN_RSRP, fit, eval_model
...
n_antenna = 64
nepoch = 200         # 200 by default
batch_size = 500     # 500 by default         
noise_factor = -13   # dB
noise_power_dBm = -161
noiseless = False
ifsavemodel = False
...
#%%
dataset_name = 'O1_28_ULA' # 'Rosslyn_ULA' or 'O1_28B_ULA' or 'I3_60_ULA' or 'O1_28_ULA'
...
if dataset_name == 'Rosslyn_ULA':
    ...
    fname_h_real = './Dataset/DeepMIMODataset/O1_28B_ULA/h_real.mat'
    fname_h_imag = './Dataset/DeepMIMODataset/O1_28B_ULA/h_imag.mat'
    h_real = sio.loadmat(fname_h_real)['h_real']
    h_imag = sio.loadmat(fname_h_imag)['h_imag']
    tx_power_dBm = 20
elif dataset_name == 'I3_60_ULA':
    fname_h_real = './Dataset/DeepMIMODataset/I3_60_ULA/h_real.mat'
    fname_h_imag = './Dataset/DeepMIMODataset/I3_60_ULA/h_imag.mat'
    h_real = sio.loadmat(fname_h_real)['h_real']
    h_imag = sio.loadmat(fname_h_imag)['h_imag']
    tx_power_dBm = 10
elif dataset_name == 'O1_28_ULA':
    fname_h_real = './Dataset/DeepMIMODataset/O1_28_ULA/h_real.mat'
    fname_h_imag = './Dataset/DeepMIMODataset/O1_28_ULA/h_imag.mat'
    h_real = sio.loadmat(fname_h_real)['h_real']
    h_imag = sio.loadmat(fname_h_imag)['h_imag']
    tx_power_dBm = 10
else:
...
for n_wb_i, n_wb in enumerate(n_wide_beams):
    ...
    # learnable_model_savefname = './Dataset/Rosslyn/SaveModel/{}_trainable_{}_beam_probing_codebook_{}_beam_classifier_noise_{}_dBm.pt'.format(dataset_name,n_wb,n_nb,noise_power_dBm)
    
    learnable_model_savefname = './Dataset/DeepMIMODataset/O1_28_ULA/SaveModel/{}_trainable_{}_beam_probing_codebook_{}_beam_classifier_noise_{}_dBm.pt'.format(dataset_name,n_wb,n_nb,noise_power_dBm)
    ...
    if ifsavefigure == True:
        plt.savefig('O1_Trainablecodebook{}wb{}nb.jpg'.format(n_wb,n_nb))
    ...
    dft_codebook_model = Beam_Classifier(n_antenna = n_antenna,
                                         n_wide_beam = n_wb,
                                         n_narrow_beam = n_nb,
                                         trainable_codebook = False,
                                         complex_codebook = dft_wb_codebook,
                                         noise_power = noise_power,
                                         norm_factor = norm_factor)
    ...
    dft_model_savefname = './Dataset/Rosslyn/SaveModel/{}_DFT_{}_beam_probing_codebook_{}_beam_classifier_noise_{}_dBm.pt'.format(dataset_name,n_wb,n_nb,noise_power_dBm)
    ...
    plt.show()
    plt.savefig('DFTcodebook{}wb{}nb.jpg'.format(n_wb,n_nb))
    ...
    AMCF_codebook_model = Beam_Classifier(n_antenna = n_antenna,
                                          n_wide_beam = n_wb,
                                          n_narrow_beam = n_nb,
                                          trainable_codebook = False,
                                          complex_codebook = AMCF_wb_codebook,
                                          noise_power = noise_power,
                                          norm_factor = norm_factor)
    ...
    AMCF_model_savefname = './Dataset/Rosslyn/SaveModel/{}_AMCF_{}_beam_probing_codebook_{}_beam_classifier_noise_{}_dBm.pt'.format(dataset_name,n_wb,n_nb,noise_power_dBm)
    ...
    plt.show()
    plt.savefig('AMCFcodebook{}wb{}nb.jpg'.format(n_wb, n_nb))
    ...
    dft_codebook_cnn_model = Beam_Classifier_CNN(n_antenna = n_antenna,
                                                 n_wide_beam = n_wb,
                                                 n_narrow_beam = n_nb,
                                                 trainable_codebook = False,
                                                 complex_codebook = dft_wb_codebook,
    ...
    dft_cnn_model_savefname = './Dataset/Rosslyn/SaveModel/{}_DFT_{}_beam_probing_codebook_{}_beam_complex_input_CNN_classifier_noise_{}_dBm.pt'.format(dataset_name,n_wb,n_nb,noise_power_dBm)
    ...
    plt.show()  
    plt.savefig('DFTCNNcodebook{}wb{}nb.jpg'.format(n_wb,n_nb))
